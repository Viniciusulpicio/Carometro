      ...
      <div className='inputCadastro'> {/* Container para os campos de entrada */}
        <div className='geralCadastro'> {/* Container geral para organização */}
          ...
          <div className='cadastro-inputs'>
            ...
            <div className="quebrar-linha"> {/* Dividir em linhas */}
            ...
            <div className="quebrar-linha2"> {/* Dividir em linhas */}
              {/* Campos de entrada para data de nascimento, turma, turno e CPF */}
              <div>
          ...
          {/* Botão para continuar o cadastro, vinculado à rota '/Carometro-universal/home' */}
